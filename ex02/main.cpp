...
TEST_START(Array_constructor)
	TEST_LOGIC_START
		...
		TEST_ANY_EXCEPTION(iarr[-2])
		TEST_ANY_EXCEPTION(iarr[11])
		TEST_ANY_EXCEPTION(iarr[-2] = 2)
		...
		TEST_ANY_EXCEPTION(sarr[5])
		TEST_ANY_EXCEPTION(sarr[5])
		TEST_ANY_EXCEPTION(sarr[-1])
		TEST_ANY_EXCEPTION(sarr[5] = "hello")
		TEST_ANY_EXCEPTION(sarr[5] = "hello")
		TEST_ANY_EXCEPTION(sarr[-1] = "hello")
	TEST_LOGIC_END
	TEST_EMERGENCY_START
	TEST_EMERGENCY_END
TEST_END
